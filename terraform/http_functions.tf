...
resource "google_cloudfunctions_function_iam_member" "wewu_api_register_service_member" {
  project = google_cloudfunctions2_function.http_cf_template["wewu_api_register_service"].project
  region = google_cloudfunctions2_function.http_cf_template["wewu_api_register_service"].location
